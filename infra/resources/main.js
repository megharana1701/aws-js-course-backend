...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src\\app\\core\\header\\header.component.ts", lineNumber: 31 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductItemComponent, { className: "ProductItemComponent", filePath: "src\\app\\products\\product-item\\product-item.component.ts", lineNumber: 50 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductsComponent, { className: "ProductsComponent", filePath: "src\\app\\products\\products.component.ts", lineNumber: 14 });
})();
...
var appRoutes = [
  ...
  {
    path: "cart",
    loadChildren: () => import("./cart-routes-NPNGGVU3.js")
  },
  {
    path: "admin",
    loadChildren: () => import("./admin-routes-PODU25OJ.js")
  }
];
